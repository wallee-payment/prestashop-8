...
abstract class WalleeAbstractmigration
{
    ...
    protected static function installTableBase()
    {
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_method_configuration(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_transaction_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_token_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_cart_meta(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_order_meta(
				`order_id` int(10) unsigned NOT NULL,
                `meta_key` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
                `meta_value` longtext COLLATE utf8_unicode_ci NULL,
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_void_job(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_completion_job(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wle_refund_job(
    ...
    {
        $authorizedStatus = WalleeOrderstatus::getAuthorizedOrderStatus();
        $waitingStatus = WalleeOrderstatus::getWaitingOrderStatus();
        $manualStatus = WalleeOrderstatus::getManualOrderStatus();

        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_FAILED, Configuration::get('PS_OS_ERROR'));
        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_AUTHORIZED, $authorizedStatus->id);
        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_VOIDED, Configuration::get(
            'PS_OS_CANCELED'
        ));
        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_COMPLETED, $waitingStatus->id);
        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_MANUAL, $manualStatus->id);
        Configuration::updateGlobalValue(
            WalleeBasemodule::CK_STATUS_DECLINED,
            Configuration::get('PS_OS_CANCELED')
        );
        Configuration::updateGlobalValue(WalleeBasemodule::CK_STATUS_FULFILL, Configuration::get(
            'PS_OS_PAYMENT'
        ));
    }
    ...
    {
        WalleeHelper::getModuleInstance()->registerHook('actionObjectOrderPaymentAddBefore');
    }
    ...
    protected static function updateCustomerIdOnTokenInfoBase()
    {
        ...
        $result = $instance->execute(
            ...
            "wle_token_info` CHANGE `customer_id` `customer_id` int(10) unsigned NULL DEFAULT NULL;"
        );
        if ($result === false) {
            throw new Exception($instance->getMsgError());
        }
